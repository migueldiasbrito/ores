...
int main(int argc, char* args[])
{
	...
	engine.AddGameObject(new ores::game_engine::Button(engine.GetRenderer(), fontCache, 0, 0, 400, 100, 0xFF, 0xFF, 0xFF, 0xFF, "../../Resources/Fonts/consola.ttf", 28, "Le Text", 0x00, 0x00, 0x00, 0xFF));
